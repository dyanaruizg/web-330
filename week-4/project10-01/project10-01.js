...
for (let item of pieces) {
  // Grab the piece in response to the pointerdown event
  item.addEventListener("pointerdown", grabPiece);
}

// Grab a piece from the puzzle to begin drag and drop
